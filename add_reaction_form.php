    ...
    <section class="container">
      <div class="content__container">
        <h1>
          ...
          <span class="heading__1">Add Reaction</span><br />
          
        </h1>
        <form action="add_reaction.php" method="post">
          <input type="text" placeholder="Reaction label" required name="LibelleR">
          
          <div class="link">
            <button type="submit" class="login">Add a Reaction</button>
            <a href="see_reaction.php" class="forgot">Cancel</a>
          </div>
          <hr>
