    ...
    <section class="container">
      <div class="content__container">
        <h1>
          ...
          <span class="heading__1">Update Reaction info</span><br />
          
        </h1>
        <form action="update_reaction.php" method="post">
          <input type="text" placeholder="Reaction Code (CodeR)" required name="CodeR">
          <input type="text" placeholder="Reaction Label (libelleR)" required name="LibelleR">
