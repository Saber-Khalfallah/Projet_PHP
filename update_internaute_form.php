    ...
    <section class="container">
      <div class="content__container">
        <h1>
          ...
          <span class="heading__1">Update user info</span><br />
          
        </h1>
        <form action="update_internaute.php" method="post">
          <input type="text" placeholder="Id internaute" required name="IdInter">
