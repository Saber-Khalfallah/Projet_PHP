    ...
    <section class="container">
      <div class="content__container">
        <h1>
          ...
          <span class="heading__1">List of Reactions</span><br />
          
        </h1>
    <table id="customers">
        <tr>
            <th>Reaction Code (CodeR)</th>
            <th>Libelle Reaction</th>
        </tr>

        <?php foreach ($reactions as $reaction): ?>
            <tr>
                <td><?php echo $reaction['CodeR']; ?></td>
                <td><?php echo $reaction['LibelleReaction']; ?></td>
                <td>
                    <form action="remove_reaction.php" method = "post"><input type="hidden" <?php echo 'value='.$reaction['CodeR']?> name="CodeR"><button type="submit" >delete</button>
                    </form>
                    <button type="submit" ><a href="update_reaction_form.php">Update</a></button>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>

    <a class="button" href="add_reaction_form.php">Add Reaction</a>
    </div>
      </div>
